...
public class LastPlayed {
	...
	private void initialize() {
		...
		JEditorPane dtrpnLastPlayed = new JEditorPane();
		dtrpnLastPlayed.setFont(new Font("Tahoma", Font.PLAIN, 24));
		dtrpnLastPlayed.setText("Last Played");
		panel_2.add(dtrpnLastPlayed, "cell 7 2 5 1,grow");
