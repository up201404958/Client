...
public class Search {
	...
	private void initialize() {
		...
		JEditorPane dtrpnResultsFound = new JEditorPane();
		dtrpnResultsFound.setFont(new Font("Tahoma", Font.PLAIN, 24));
		dtrpnResultsFound .setText("Results Found");
		panel_2.add(dtrpnResultsFound , "cell 7 2 5 1,grow");
