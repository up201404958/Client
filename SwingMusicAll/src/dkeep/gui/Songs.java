...
public class Songs {
	...
	private void initialize() {
		...
		JEditorPane dtrpnSongs = new JEditorPane();
		dtrpnSongs.setFont(new Font("Tahoma", Font.PLAIN, 24));
		dtrpnSongs.setText("Songs");
		panel_2.add(dtrpnSongs, "cell 7 2 5 1,alignx center,growy");
